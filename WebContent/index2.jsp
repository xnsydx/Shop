				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProductList }" var="hotPro">
						...
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							<p><a href="${pageContext.request.contextPath }/product?method=productIndexInfo&pid=${hotPro.pid}" style='color:#666'>${hotPro.pname }</a></p>
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProductList }" var="newPro">
						...
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							<p><a href="${pageContext.request.contextPath }/product?method=productIndexInfo&pid=${newPro.pid}" style='color:#666'>${newPro.pname }</a></p>
